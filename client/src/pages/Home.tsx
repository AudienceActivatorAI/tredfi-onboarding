...
import { ArrowRight, Check, ChevronLeft, ChevronRight, ShieldCheck, Save, Loader2, Calendar, Clock , Trash2} from "lucide-react";
                ...
                <Card className="border-none shadow-2xl overflow-hidden">
                  <div className="grid md:grid-cols-2 gap-0">
                    ...
                    <div className="p-8 flex flex-col justify-center space-y-6">
                      ...
                      {currentStep > 0 && (
                        <Button type="button" variant="outline" size="sm" onClick={clearProgress} className="w-full mt-2">
